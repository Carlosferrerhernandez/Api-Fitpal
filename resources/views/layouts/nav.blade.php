                ...
                @auth
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                            ...
                            @endcan
                            @can('view-any', App\Models\Gym::class)
                            <a class="dropdown-item" href="{{ route('gyms.index') }}">Gimnasios</a>
                            @endcan
                            @can('view-any', App\Models\Category::class)
                            <a class="dropdown-item" href="{{ route('categories.index') }}">Categorías</a>
                            @endcan
                            @can('view-any', App\Models\Trainer::class)
                            <a class="dropdown-item" href="{{ route('trainers.index') }}">Entrenadores</a>
                            @endcan
